...
# Contar los valores únicos y crear df_countriesProd
df_countriesProd = df_countries.groupby(['countries', 'countries_keys']).size().reset_index(name='productions')

# Mostrar el DataFrame df_countriesProd resultante
print(df_countriesProd.info())
print(df_countriesProd)

df_countriesProd.to_parquet('pq_countries.parquet', index= False)
